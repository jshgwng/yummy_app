...
import 'package:yummy_app/widgets/product_card_widget.dart';
...
class _SalesReportWindowState extends State<LowStockReportScreen> {
  ...
  void initState() {
    super.initState();
    _futureProducts = _productService.lowStockAlert();
  }
